...
export const WEB_SEARCH: ToolSpec = {
  name: 'web_search',
  description: 'Search the web for current information. Returns result links and snippets only - use fetch_url to read a result. If results suggest several distinct datasets or interpretations of the user request, use request_user_choice before fetching large data.',
  parameters: {
    type: 'object',
    properties: {
